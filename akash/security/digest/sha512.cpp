...
namespace digest {
    ...
    void SHA512::init() {
        ...
        context_.intermediate_hash[0] = 0x6A09E667F3BCC908ll;
        context_.intermediate_hash[1] = 0xBB67AE8584CAA73Bll;
        context_.intermediate_hash[2] = 0x3C6EF372FE94F82Bll;
        context_.intermediate_hash[3] = 0xA54FF53A5F1D36F1ll;
        context_.intermediate_hash[4] = 0x510E527FADE682D1ll;
        context_.intermediate_hash[5] = 0x9B05688C2B3E6C1Fll;
        context_.intermediate_hash[6] = 0x1F83D9ABFB41BD6Bll;
        context_.intermediate_hash[7] = 0x5BE0CD19137E2179ll;
     ...
     *
     */
    int SHA512::update(const uint8_t* bytes, unsigned int length) {
     ...
     *
     */
    int SHA512::finalBits(uint8_t bits, unsigned int length) {
     ...
     *
     */
    int SHA512::result(uint8_t msg_digest[kHashSize]) {
     ...
     *
     */
    void SHA512::processMessageBlock(Context* context) {
     ...
     *
     */
    void SHA512::finalize(Context* context, uint8_t pad_byte) {
        padMessage(context, pad_byte);
        /* message may be sensitive, clear it out */
        for (uint16_t i = 0; i < kMsgBlockSize; ++i)
     ...
     *
     */
    void SHA512::padMessage(Context* context, uint8_t pad_byte) {
        /*
