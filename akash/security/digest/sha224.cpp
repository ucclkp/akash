...
namespace digest {
    ...
    void SHA224::init() {
        ...
        context_.intermediate_hash[0] = 0xC1059ED8;
        context_.intermediate_hash[1] = 0x367CD507;
        context_.intermediate_hash[2] = 0x3070DD17;
        context_.intermediate_hash[3] = 0xF70E5939;
        context_.intermediate_hash[4] = 0xFFC00B31;
        context_.intermediate_hash[5] = 0x68581511;
        context_.intermediate_hash[6] = 0x64F98FA7;
        context_.intermediate_hash[7] = 0xBEFA4FA4;
     ...
     *
     */
    int SHA224::update(const uint8_t* bytes, unsigned int length) {
     ...
     *   sha Error Code.
     */
    int SHA224::finalBits(uint8_t bits, unsigned int length) {
    ...
    * Parameters:
     ...
     *   sha Error Code.
     */
    int SHA224::result(uint8_t msg_digest[kHashSize]) {
 ...
 */
    void SHA224::processMessageBlock(Context* context)
    {
     ...
     *   sha Error Code.
     */
    void SHA224::finalize(Context* context, uint8_t pad_byte) {
     ...
     *   Nothing.
     */
    void SHA224::padMessage(Context* context, uint8_t pad_byte) {
        /*
