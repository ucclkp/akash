...
int TEST_MD5() {
    DCHECK(digest::MD5::cal("") == "D41D8CD98F00B204E9800998ECF8427E");
    DCHECK(digest::MD5::cal("", 1) == "D41D8CD98F00B204E9800998ECF8427E");
    DCHECK(digest::MD5::cal("a") == "0CC175B9C0F1B6A831C399E269772661");
    DCHECK(digest::MD5::cal("a", 2) == "0CC175B9C0F1B6A831C399E269772661");
    DCHECK(digest::MD5::cal("12345678901234567890123456789012345678901234567890123456") == "49F193ADCE178490E34D1B3A4EC0064C");
    DCHECK(digest::MD5::cal("12345678901234567890123456789012345678901234567890123456", 1) == "49F193ADCE178490E34D1B3A4EC0064C");
    DCHECK(digest::MD5::cal("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", 63) == "D174AB98D277D9F5A5611C2C9F419D9F");
    DCHECK(digest::MD5::cal("12345678901234567890123456789012345678901234567890123456789012345678901234567890") == "57EDF4A22BE3C955AC49DA2E2107B67A");
    DCHECK(digest::MD5::cal("12345678901234567890123456789012345678901234567890123456789012345678901234567890", 1) == "57EDF4A22BE3C955AC49DA2E2107B67A");
